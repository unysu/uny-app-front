...
class _OtherUsersPage extends State<OtherUsersPage>
  ...
  List<GiftModel> giftsList = [
    ...
    GiftModel(
        ...
        type: ''),
    GiftModel(
        image: 'assets/gifts/ratman.png', name: 'Ratman', price: '0', type: ''),
    GiftModel(
  ...
  void initState() {
    ...
    if (user!.media!.otherPhotosList != null) {
      videos = user!.media!.otherPhotosList!
          .where((element) => element.type.toString().startsWith('video'))
          .toList();
      photos = user!.media!.otherPhotosList!
          .where((element) => element.type.toString().startsWith('image'))
          .toList();
    }
                    ...
                    Expanded(
                      ...
                      onTap: () {
                        ...
                        _isReactionButtonTapped
                            ...
                            : controller.reverse();
                        _isReactionButtonTapped
                            ? emojisAnimationController.forward()
                            : emojisAnimationController.reverse();
                                                              ...
                                                              giftsList[index]
                                                                  ...
                                                                  ? Positioned(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: Center(
                                                                            child:
                                                                                Text('NEW', style: TextStyle(fontSize: 8, color: Colors.white))),
                                                                        decoration: BoxDecoration(
                                                                  ...
                                                                  : giftsList[index]
                                                                      ...
                                                                      ? Positioned(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Center(child: Text('VIP', style: TextStyle(fontSize: 8, color: Colors.white))),
                                                                            decoration:
                                                                                BoxDecoration(color: Colors.black, borderRadius: BorderRadius.all(Radius.circular(20))),
                                                                          ),
                                                                        )
                                                                      : SizedBox()
                                                            ],
                                                                                ...
                                                                                child: Center(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Row(
                                                                                      ...
                                                                                      children: [
                                                                                        Text(
                                                                                          giftsList[_selectedGiftIndex!].price == '0' ? 'Бесплатно' : giftsList[_selectedGiftIndex!].price!,
                                                                              ...
                                                                              giftsList[_selectedGiftIndex!].type == 'new'
                                                                                  ? Positioned(
                                                                                      ...
                                                                                      child: Container(
                                                                                        ...
                                                                                        child: Center(child: Text('NEW', style: TextStyle(fontSize: 13, color: Colors.white))),
                                                                                        decoration: BoxDecoration(color: Color.fromRGBO(253, 43, 93, 10), borderRadius: BorderRadius.all(Radius.circular(20))),
                                                                                      ),
                                                                                    )
                                                                                  : giftsList[_selectedGiftIndex!].type == 'vip'
                                                                                      ? Positioned(
                                                                                          ...
                                                                                          child: Container(
                                                                                            padding: EdgeInsets.symmetric(vertical: 4, horizontal: 10),
                                                                                            child: Center(child: Text('VIP', style: TextStyle(fontSize: 13, color: Colors.white))),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            filled:
                                                                                true,
                                                                            border:
                                                                                OutlineInputBorder(borderRadius: BorderRadius.circular(20), borderSide: BorderSide(color: Colors.grey.withOpacity(0.2))),
                                                                            focusedBorder:
                                                                                OutlineInputBorder(borderRadius: BorderRadius.circular(20), borderSide: BorderSide(color: Colors.grey.withOpacity(0.2))),
                                                                            enabledBorder:
                                                                                OutlineInputBorder(borderRadius: BorderRadius.circular(20), borderSide: BorderSide(color: Colors.grey.withOpacity(0.2))),
                      ...
                      onTap: () async {
                        ...
                        await UnyAPI.create(Constants.SIMPLE_RESPONSE_CONVERTER)
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                              content: Text('Перейдите в раздел сообщения',
                                  style:
                                    ...
                                    children: [
                                      ...
                                      Transform.scale(
                                        ...
                                        child: Checkbox(
                                          ...
                                          splashRadius: UniversalPlatform.isIOS
                                              ? 2
                                              : null,
                                          activeColor:
                                              Color.fromRGBO(145, 10, 251, 5),

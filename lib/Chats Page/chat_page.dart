...
class _UserChatPageState extends State<UserChatPage> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    socket.getStream()!.listen((event) {
      if(utf8.decode(event).contains('msg')){
        ...
        if(!(_messagesList.contains(message))){
    ...
    if(chat.messages!.isNotEmpty){
     ...
     WidgetsBinding.instance.addPostFrameCallback((_) async {
       albums = await PhotoManager.getAssetPathList(hasAll: true, type: RequestType.all);
       media = await albums[0].getAssetListPaged(page: 0, size: 30);
     });
        ...
        return ResponsiveWrapper.builder(
          Scaffold(
            ...
            appBar: AppBar(
              ...
              toolbarHeight: 70,
              leadingWidth: _isSelecting ? 100 : 30,
                    ...
                    Stack(
                      children: [
                        Container(
                          height: 60,
                          width: 60,
                          child: chat.participants![0].media!.mainPhoto != null ? CachedNetworkImage(
    ...
    return FutureBuilder<Response<RoomMessagesModel>>(
      ...
      builder: (context, snapshot){
        ...
        if(snapshot.connectionState == ConnectionState.done && snapshot.hasData){
          ...
          _checkedMessages = List.generate(_messagesList.length, (index) => false);
  ...
  Widget mainBody(){
    return Stack(
      children: [
        ...
        _messagesList.isNotEmpty ? Container(
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      _messagesList[index].replyTo != null ? Container(
                                        height: 40,
                                        width: 150,
                                        child: Row(
                                          children: [
                                            VerticalDivider(
                                              color: Provider.of<UserDataProvider>(context, listen: false).userDataModel!.id == _messagesList[index].userId ? Colors.white : Colors.black,
                                              thickness: 2,
                                            ),
                                            _messagesList[index].replyTo['media'] != null ?
                                                Container(
                                                  height: 40,
                                                  width: 40,
                                                  child: CachedNetworkImage(
                                                    imageUrl: _messagesList[index].replyTo['media'][0]['type'].toString().startsWith('video')
                                                    ? _messagesList[index].replyTo['media'][0]['thumbnail']
                                                    : _messagesList[index].replyTo['media'][0]['media'],
                                                    imageBuilder: (context, imageProvider) => Container(
                                                      height: 40,
                                                      width: 40,
                                                      decoration: BoxDecoration(
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                Text(
                                                    Provider.of<UserDataProvider>(context, listen: false).userDataModel!.id == _messagesList[index].replyTo['user_id']
                                                        ? '${Provider.of<UserDataProvider>(context, listen: false).userDataModel!.firstName}' : '${chat.participants![0].firstName}',
                                                  style: TextStyle(color: Provider.of<UserDataProvider>(context, listen: false).userDataModel!.id == _messagesList[index].userId ? Colors.white : Colors.black, fontSize: 17, fontWeight: FontWeight.w600),
                                                ),
                                                Container(
                                                  width: 80,
                                                  child: Text(
                                                    _messagesList[index].replyTo['text'],
                                                    style: TextStyle(
                                                        fontSize: 14,
                                                        color: Provider.of<UserDataProvider>(context, listen: false).userDataModel!.id == _messagesList[index].userId ? Colors.white : Colors.black,
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text('${_messagesList[_currentlyEditingMessageIndex!].text == null ? '' : _messagesList[_currentlyEditingMessageIndex!].text}'),
                          ],
                        ),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          _messagesList[_currentlyReplyingMessageIndex!].media != null ? Container(
                            height: 50,
                            width: 50,
                            child: CachedNetworkImage(
                              imageUrl: _messagesList[_currentlyReplyingMessageIndex!].media[0]['type'].toString().startsWith('video')
                                  ? _messagesList[_currentlyReplyingMessageIndex!].media[0]['thumbnail']
                                  : _messagesList[_currentlyReplyingMessageIndex!].media[0]['media'],
                            )
                          ) : Container(),
                          SizedBox(width: 5),
                          Container(
                            width: _messagesList[_currentlyReplyingMessageIndex!].media != null ? width / 1.4 : width / 1.2,
                              ...
                              children: [
                                Container(
                                    ...
                                    child: Row(
                                      children: [
                                        Text(
                                            Provider.of<UserDataProvider>(context, listen: false).userDataModel!.id == _messagesList[_currentlyReplyingMessageIndex!].userId ?
                                            'Ответить ${Provider.of<UserDataProvider>(context, listen: false).userDataModel!.firstName}' : 'Ответить ${chat.participants![0].firstName}',
                                ...
                                Container(
                                    child: Row(
                                      children: [
                                        Container(
                                          width: width / 2,
                                          child: Text('${_messagesList[_currentlyReplyingMessageIndex!].text == null ? '' : _messagesList[_currentlyReplyingMessageIndex!].text}', overflow: TextOverflow.ellipsis, maxLines: 2),
                                        )
                                      ],
                                    )
                                ),
                                            ...
                                            onPressed: () async {
                                              ...
                                              for(int i = 0; i < _selectedMessagesList.length; i++){
                                                if(_selectedMessagesList[i] == true){
                                                  _messageIds.add(_messagesList[i].messageId);
                                                }
                                              }

                                              deleteMultipleMessages('', Provider.of<UserDataProvider>(context, listen: false).userDataModel!.id, chat.participants![0].id, _messageIds);
                                            },
                                          ),
                                          CupertinoActionSheetAction(
                                            child: Text(
  ...
  void sendMessage() async {
    ...
    var data = {
      ...
      'reply_to_message_id' : _currentlyReplyingMessageIndex != null ? _messagesList[_currentlyReplyingMessageIndex!].messageId : '',
    ...
    _controller!.animateTo(_controller!.position.maxScrollExtent, duration: Duration(milliseconds: 250), curve: Curves.fastOutSlowIn);
  }
  ...
  void deleteMessage(String forWho, int myId, int? participantId, int messageId) async {
    ...
    if(_messagesList.isNotEmpty){
      Provider.of<ChatsDataProvider>(context, listen: false).setLastMessage(chat.chatRoomId, _messagesList.last.text);
      Provider.of<ChatsDataProvider>(context, listen: false).setLastMessageTime(chat.chatRoomId, _messagesList.last.createdAt);
    }else{
  ...
  void deleteMultipleMessages(String forWho, int myId, int? participantId, List<int> messagesIds) async {
    ...
    await UnyAPI.create(Constants.SIMPLE_RESPONSE_CONVERTER).deleteMessage(token, data).whenComplete((){
      for(int i = 0; i < messagesIds.length; i++){
        _messagesList.removeWhere((element) => element.messageId == messagesIds[i]);
      }
